...
# ThorUI 
ThorUI组件库小程序原生版本，该开源版源码为V1.4.2版本，后续更新版本付费会员才可使用（￥180/永久）【线上最新版为V2.8.0】。
...
注：会员专用内容加入会员才可使用（￥180/永久)，付费模板会员可享受折扣。
...
注：自1.4.2版本之后，ThorUI只对uni-app版本进行开源，小程序原生版付费会员才可使用（￥180/永久），1.4.2版本之前不受影响。
