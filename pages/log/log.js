	...
	data: {
		...
		logList: [{
			...
			},
			{
				version: '1.2.2',
				date: '2019-07-11',
				log: ['1.新增组件Modal弹框:可设置按钮数，按钮样式，提示文字样式等，还可自定义弹框内容。', '2.修复已知bug',
					'3.ThorUI组件文档地址：http://www.donarui.com/'
				]
			},
			{
				version: '1.3.0',
			...
			},
			{
				...
				log: [
					...
					'20.引入优化uParse。（uni-app版本）',
					'21.搜索页面新增关键词高亮显示。',
					'22.新增navbar上拉加载下拉刷新案例。',
					'23.v3编译支持。（uni-app版本）',
					'24.支持easycom组件模式，直接在页面中使用组件，无需引入注册。（uni-app版本）',
			...
			},
			{
				...
				log: [
					'1.日历组件支持农历（古历）。',
					'2.sticky吸顶组件改为wxs实现。',
					'3.新增圆形进度条组件canvas 2d实现，同层渲染且性能更佳。',
			...
			},
			{
				...
				log: [
					...
					'--------------------------',
					'--------------------------',
					'注：小程序1.4.2版本之后更新内容以及标注【会员专用】部分加入会员才可使用（￥200/永久)。',
			...
			},
			{
				...
				log: [
					...
					'--------------------------',
					'--------------------------',
					'注：小程序1.4.2版本之后更新内容以及标注【会员专用】部分加入会员才可使用（￥200/永久)，付费模板会员可享受折扣。',
					'如若需要，请联系QQ：3168647172 或 3039218619。'
				]
			},
			{
			...
			},
			{
				...
				log: [
					...
					'16.tui-datetime（日期时间选择器）组件优化，修复部分平台会导致数据重置的问题。',
